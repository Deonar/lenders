...
<div class="breadcrumb">
	<div class="container">
        <ul class="breadcrumb__wrapper">
            <li class="breadcrumb__item"><a href="/<?php echo get_page_uri( 13 ); ?>">Микрозаймы</a></li>
	...
	<div class="container">
		...
		<div class="card-single__wrapper">
			...
			<div class="card-single__head">
				...
				<p class="bank-name">
					<?php the_field('bank-text');?>
				</p>
				<div class="bank-logo__container">
					<div class="bank-logo">
		...
		<div class="btn-mob">
			<a href="<?php the_field('p_content');?>" class="btn btn_hover btn-more w-100 uppercase" tabindex="-1">
	 			Перейти на сайт
	 		</a>
 		</div>
