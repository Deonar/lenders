	...
	<section class="banner">
		<div class="container banner__wrapper">
			...
			<div class="phone-form">
				<h1 class="title">
					Персональный подбор дебетовых карт
				</h1>
		...
		<div class="container">
			<div class="cards-select">
				<div class="cards-select__item">
					<a href="/<?php echo get_page_uri( 15 ); ?>">
						Кредитные карты
					</a>
				</div>
				<div class="cards-select__item">
					<a href="/<?php echo get_page_uri( 17 ); ?>" class="active">
						Дебетовые карты
					</a>
				</div>
			</div>
	...
	<div class="steps-form__container">
		...
		<form action="#" class="steps-form__wrapper" id="steps-form_1">
			...
			<div class="form-range">
				<input type="text" id="spend-term" readonly name="spend-term">
				<label>Сколько тратите в месяц?</label>
				<div id="spend-term-range"></div>
			</div>
			
			<div class="form-input">
				<select class="custom-select" id="select-currency" name="select-currency">
			...
			<div class="form-accordion">
				...
				<div class="accordion-contant mb-20 accordion-contant-js">
					<div class="form-input">
						<select class="custom-select" id="select-cashback" name='select-cashback'>
							<option value="" disabled selected hidden>Кэшбэк</option>
					...
					<div class="checkbox__wrapper">
						...
						<div class="checkbox__input">
						    ...
						    <label for="additional-2">Проценты на остаток</label>
						</div>
			        </div>
				</div>
			</div>
